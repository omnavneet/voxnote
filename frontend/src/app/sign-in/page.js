  ...
  return (
    <div className="min-h-screen px-56 bg-black text-white flex relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-orange-600/10 blur-3xl rounded-full" />
        <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-red-600/10 blur-3xl rounded-full" />
      </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center p-8">
        ...
        >
          ...
          <p className="text-lg text-gray-400">Sign in to access your VoxNote workspace</p>
        </motion.div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-12 relative">
        ...
        >
          ...
          {/* Form */}
          <div className="bg-gray-900/40 backdrop-blur-xl border border-gray-800/50 rounded-2xl p-8 relative">
            {focused && (
              <motion.div
                layoutId="glow"
            ...
            <div className="relative space-y-6">
              ...
              <div>
                ...
                >
                  <input
                    ...
                    className="w-full bg-black/60 border border-gray-800 rounded-xl px-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:border-orange-600/50 transition-all"
                  />
                </motion.div>
              </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <a href="/forgot-password" className="text-xs text-orange-500 hover:text-orange-400 transition-colors">
                    Forgot?
                  </a>
                </div>
                <motion.div
          ...
          <p className="text-center mt-8 text-sm text-gray-500">
            ...
            <a href="/sign-up" className="text-orange-500 hover:text-orange-400 font-medium transition-colors">
              Sign up
            </a>
          </p>
        </motion.div>
